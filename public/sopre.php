                                ...
                                <div class="about">
                                    <div class="about__container">
                                        <div class="about__info">
                                            <h2 class="about__h2">Bem-vindo(a) à home Perfumaria !</h2>
                                            ...
                                            <a class="about__link btn--e-secondary" href="index.php" target="_blank">Compre agora</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section__text-wrap">
                                    <h1 class="section__heading u-c-secondary">Os membros da nossa equipe</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section__intro u-s-m-b-46">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section__text-wrap">
                                    <h1 class="section__heading u-c-secondary u-s-m-b-12">FEEDBACK DOS CLIENTES</h1>

                                    <span class="section__span u-c-silver">O QUE NOSSOS CLIENTES DIZEM</span>
                                </div>
                            </div>
                        </div>
                    </div>
